...
// Example: Hardcoded service slugs
...
const Services = ( { params }: { params: { service: string } }) => {
  ...
  return (
    ...
    <div className=" mx-10 min-h-screen">
      ...
      <div className='w-[80%]  md:w-[40%]'>
        <p>When you use Growlit Enterprises genuine spare parts, you get the right part exactly when you need it. Our high-quality, durable components ensure your equipment operates at peak performance throughout its lifespan, maximizing productivity and reducing ownership costs by extending its lifecycle. To find and order the correct spare parts for your equipment, simply search using the serial number below, contact your local Alfa Laval office, or fill out the form—our sales team will promptly assist you.</p>
      </div>
      </div>
